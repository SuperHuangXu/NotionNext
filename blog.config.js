...
const BLOG = {
  ...
  AUTHOR: 'bubble', // 作者
  BIO: '', // 作者简介
  LINK: 'https://blog.superhx.cn', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/SuperHuangXu', // 你的github个人主页
  ...
  PRISM_THEME_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-one-dark.min.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
